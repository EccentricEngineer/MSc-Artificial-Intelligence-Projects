...
/* Plans */
// Register welding agent to the Directory Facilitator
+!register <- .df_register("welding_agent");
...
@r1 +accept_proposal(CNPId): proposal(CNPId,Task,Offer) <- .print("Doing ", Task ,"!").
